...
$isUserAllowed = $user->can('edit-users'); // Igazat ad
			...
			\begin{itemize}
				...
				\item \emph{admin1@acs.test}: A felhasználókat és azok jogosultságait kezelheti.
				\item \emph{hr1@acs.test}: A Dolgozókat és azok csoportjait, valamint a belépési szabályokat kezelheti.
				\item \emph{supervisor1@acs.test}: A zárakat, valamint azok csoportjait kezelheti.
